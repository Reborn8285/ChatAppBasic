    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot){
        return snapshot.hasData ?  ListView.builder(
            itemCount:snapshot.data.docs.toString().length,
            itemBuilder: (context, index){
              print('ádasdasdasd');
              print(snapshot.data.docs[index].data()["message"]);
              return MessageTile(
                //message: "tydtyfygyuigi",
               message: snapshot.data.docs[index].data()["message"] == null ? "" : snapshot.data.docs[index].data()['message'],
